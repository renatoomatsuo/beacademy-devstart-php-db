...
?>
                ...
                <div class="form-floating mb-3">
                    <textarea name="description" id="description" cols="30" rows="2" class="form-control" placeholder="50"required></textarea>
                    <label class="form-label" for="description">Descrição do produto</label>
                </div>

                <div class="form-floating mb-3">
                    <input name="brand" id="brand" type="text" class="form-control" placeholder="50" required/>
                    <label class="form-label" for="brand" class="form-control" placeholder="nome da marca">Marca do produto</label>
                </div>

                <div class="form-floating mb-3">
                    <input name="quantity" id="quantity" type="number" class="form-control" placeholder="50" required/>
                    <label class="form-label" for="quantity"  required>Quantidade no estoque</label>
                </div>

                <div class="form-floating mb-3">
                    <input name="price" id="price" type="float" class="form-control" placeholder="100.00" required/>
                    <label class="form-label" for="price">Preço do produto</label>
                </div>

                <div class="form-floating mb-3">
                    <input name="photo" id="photo" type="text" class="form-control" placeholder="name@example.com" required/>
